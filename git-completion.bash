...
<html>
  ...
  <body>
    <div id="main">
      <div id="header" class="basic">
        <a class="logo boring" href="/">
          <img src="/images/modules/header/logov3.png" class="default" alt="github" />
          <img src="/images/modules/header/logov3-hover.png" class="hover" alt="github" />
        </a>
        <div class="topsearch">
          <ul class="nav logged_out">
            <li><a href="/">Home</a></li>
            <li><a href="/plans">Pricing and Signup!</a></li>
      ...
      <div class="site">
        <div id="errornew" class="standard">
          <img src="/images/error/angry_unicorn.png" alt="Unicorn is angry" />
      ...
      <div class="site">
        <div class="sponsor">
          <a href="http://www.rackspace.com" class="logo">
            <img src="/images/modules/footer/rackspace_logo.png?v2" alt="Dedicated Server" />
          </a>
        ...
        <ul class="sosueme">
          <li class="main">&copy; 2011 Inc. All rights reserved.</li>
    ...
    <script type="text/javascript">
      if(location.pathname.indexOf('/50') == -1) {
        var _kmq = _kmq || [];
        function _kms(u){
        ...
        _kmq.push(['record', 'Error Page', {'Error Code': '502'}]);
      }
    </script>
  </body>
</html>
